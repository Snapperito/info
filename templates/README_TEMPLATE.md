![Banner]( Banner link (or local file) goes here)  
<!---
you can make banners using vizalitys banner template over at [https://www.figma.com/@vizality], or you can make a custom one in any image editor 
-->

<!--
centered readme badges, feel free to remove or ad any as you please - find the places you need to edit by searching for the --CAPITAL LETTERS-- 
-->

  <p align="center">
    <a href="--DISCORD LINK--"><img align="center" alt="Discord" src="https://img.shields.io/discord/786750604419792926?color=745EC5&label=DISCORD&logo=discord&logoColor=white&style=for-the-badge"></a>
...
![Preview]( preview link or local file )
<!-- This will act as your main preview for the project, show it off :) 
-->
---

## Installation

<!-- steps to install, some example steps have been placed below (for themes)-->
...
## Credits
<!-- area to credit people, a good way to do this is by adding their name like so "@snapperito" with a hyperlink to their profile ^^-->